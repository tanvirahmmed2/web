...
export default function Login(props) {
  ...
  return (
    <div className='w-full h-screen  flex items-center justify-center'>
      <div id='signinbox' className={`w-160 border-1 border-teal-700 bg-white h-[60vh] overflow-hidden ${Signin} flex-row items-center justify-center  `}>
      ...
      <div  id='signupbox' className={`w-160 border-1 border-teal-700 bg-white h-[60vh] overflow-hidden ${Signup} flex-row items-center justify-center  `}>
        <div className={`bg-teal-700 text-white w-[50%] h-[60vh] flex flex-col items-center justify-center`}>
          <h3>Welcome to</h3>
          <h1 className='font-bold text-3xl'>{props.title}</h1>
